...
class QuarterHeadPlus(nn.Module):
    def __init__(self, embed_dim, width=64, blocks=3, norm="ln", groups=4):
        super().__init__()
        # TODO Rethink whether this extreme bottleneck makes sense for the larger models...
        C = width or max(embed_dim, 128)     # small widening helps
        # C = embed_dim // 2
...
class Upsampler(nn.Module):
    def __init__(self, adapter):
        ...
        self.head = QuarterHeadPlus(adapter.backbone.embed_dim)
