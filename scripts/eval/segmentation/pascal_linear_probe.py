...
from scripts.eval.segmentation.ade20k_linear_probe import (
    set_seed, LinearSegProbe, compute_confusion_matrix, train_one_epoch, color_to_tensor
)
...
def main():
    ...
    p.add_argument('--save-dir', type=str, default="results/PASCAL")
    ...
    save_stub = args.backbone_model_name if args.img_size == 256 else f"{args.backbone_model_name}_{args.img_size}"
