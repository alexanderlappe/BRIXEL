...
from brixel.utils.Dataset import ImageDataset, BatchRandomResizeCollate, GetLargeView, DownsampleLargeView
from brixel.utils.train_utils import full_loss, set_lr
import argparse, os
...
def train(
    ...
    do_normalize = 'dino' in backbone_model_name
...
def get_args():
    ...
    parser.add_argument("--backbone-weight-path", type=str, default='data/weights/dinov3_vitb16_pretrain_lvd1689m-73cec8be.pth',
                        help="Path to pretrained backbone weights.")
    parser.add_argument("--train-img-dir", type=str, default='data/images',
                        help="Directory with training images.")
    parser.add_argument("--val-img-dir", type=str, default='data/images_val',
    ...
    parser.add_argument("--train-size", type=float, default=1024,
