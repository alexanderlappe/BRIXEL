...
def main():
    ...
    ap.add_argument('--ann-dir', type=str, default="PASCAL/trainval/Annotations_Part/", help='Directory with .mat annotation files')
    ...
    ap.add_argument('--out-dir', type=str, default="DENSE/PASCAL/trainval/", help='Where to write train.txt / val.txt')
